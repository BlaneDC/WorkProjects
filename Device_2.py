...
for index in range(100):
    ...
    if device["vendor"] == "cisco":
        ...
        device["version"] = choice(["12.1(T).04", "14.07X", "8.12(S).010", "20"])
...
print("\n_______DEVICES AS LIST OF DICTIONARIES_________")
pprint(devices)

# USE 'TABULATE' TO PRINT TABLE OF DEVICES
print("\n________SORTED DEVICES IN TABULAR FORMAT____________")
